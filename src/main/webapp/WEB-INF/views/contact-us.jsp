			...
			<div class="row contact-grids agile-1 mb-5">
				<div class="col-sm-4 contact-grid agileinfo-6 mt-sm-0 mt-2">
					<div class="contact-grid1 text-center">
						...
						<p style="font-weight: bold;color:black;">Sky-Shop
							<label style="font-weight: bold;color:black;">Shop No.5,Palani Nagar , Chidambaram, 608001</label>
						</p>
					</div>
				</div>
				<div class="col-sm-4 contact-grid agileinfo-6 my-sm-0 my-4">
					<div class="contact-grid1 text-center">
						...
						<p style="font-weight: bold;color:black;"><a style="font-weight: bold;color:black;" href="tel:+919443272932">+(91) 9443272932</a>
...
<!-- 							<label>+(91) 121 122 000</label> -->
				...
				<div class="col-sm-4 contact-grid agileinfo-6">
					<div class="contact-grid1 text-center">
						...
						<p>
							<a style="font-weight: bold;color:black;" href="mailto:javahub018@gmail.com">rudhran981@gmail.com</a>
						</p>
					</div>
				</div>
			</div>
