...
<html>
<head>
	<title>Rudhran General Store | About </title>
		...
		<div class="container py-xl-4 py-lg-2">
			...
			<div class="row">
				<div class="col-lg-6 welcome-left">
					<h3>About Store</h3>
					<h4 class="my-sm-3 my-2">GrocSMART(Rudhran General Store) is a low-price online Grocery store, which has many vital ranging products consumed in our everyday Breakfast, Meals & Dinners. We have Fresh Vegetables, Staples, Beverages, Personal care products & many other products needed daily. All the products on our
				...
				<div class="welcome-left">
					...
					<li>Redefining India's freshest and finest food experience by 2022.</li>
